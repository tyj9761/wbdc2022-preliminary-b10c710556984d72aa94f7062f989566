...
def parse_args():
    ...
    parser.add_argument('--savedmodel_path2', type=str, default='save/v2')
    parser.add_argument('--ckpt_file_0', type=str, default='save/v1/model_epoch_3.bin')
    parser.add_argument('--ckpt_file_1', type=str, default='save/v1/model_epoch_3_fold0.bin')
    ...
    # ========================== Task =============================
    parser.add_argument('--Task', type=int, default=['mlm', 'itm'], help="linear size before final linear")
